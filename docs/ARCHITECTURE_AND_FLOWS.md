...
| **Logout** | ✅ **IMPLEMENTED:** `POST /api/v1/auth/logout` revokes the access token. Backend supports token invalidation via Redis. See `docs/archive/JWT_REVOCATION_IMPLEMENTATION_SUMMARY.md`. |
