...
/**
 * Detect low-end device for adaptive rendering (P0 enhancement)
 */
export const isLowEndDevice = (): boolean => {
  ...
  if (navigator.hardwareConcurrency && navigator.hardwareConcurrency < performance.lowEndDeviceThreshold.cores) {
    return true;
  }
