...
class SubscriptionReconciliationService(
    ...
    private fun fetchProviderStatus(sub: com.tamixa.domain.Subscription): String? {
    ...
    private fun com.tamixa.infrastructure.persistence.SubscriptionEntity.toDomain(): com.tamixa.domain.Subscription =
        com.tamixa.domain.Subscription(
            id = id,
            parentId = parent.id,
            plan = plan,
            status = status,
