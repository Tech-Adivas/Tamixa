...
import com.araro.application.port.StructuredStoryResult
import com.araro.application.port.TokenUsage
import com.araro.application.story.ModerationResult
import com.araro.application.story.ModerationCategories
...
class OpenAIClient(
    ...
    override fun generateStory(prompt: String): String {
        if (apiKey.isBlank()) {
    ...
    override fun getModerationResult(text: String): ModerationResult {
        ...
        return try {
            ...
            if (result == null) return ModerationResult(safe = true)
            ...
            log.warn("Moderation check failed, allowing content: {}", e.message)
