...
data class AppProperties(
    ...
    val soundscapes: SoundscapesProperties = SoundscapesProperties(),
    ...
    data class AuthProperties(
        ...
        /** Web app base URL for passwordless magic links (e.g. https://app.araro.com or http://localhost:3000). */
    ...
    data class SoundscapesProperties(
        val baseUrl: String = "https://cdn.araro.app/soundscapes"
    )
    ...
    data class StorageProperties(
        val type: String = "s3",
        val s3Bucket: String = "araro-audio",
    ...
    data class SubscriptionProperties(
        ...
        data class StripeProperties(
            ...
            val successUrlPrefix: String = "https://app.araro.com/subscription",
