package com.araro.android.component
...
fun FamilyVoiceRecordDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                when {
                    showConfirmStep -> com.araro.ui.strings.Strings.useThisRecording()
                    else -> com.araro.ui.strings.Strings.recordYourVoiceNow()
                },
        ...
        text = {
            Column(
                ...
                when {
                    showConfirmStep -> {
                        Text(
                            com.araro.ui.strings.Strings.useThisVoiceForStory(),
                        ...
                        Text(
                            if (isRecording) com.araro.ui.strings.Strings.tapToStopRecording()
                            else com.araro.ui.strings.Strings.tapToStartRecording(),
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
        ...
        confirmButton = {
            if (showConfirmStep) {
                TextButton(onClick = { useThisVoice() }) {
                    Text(com.araro.ui.strings.Strings.useThisVoice())
                }
            } else {
